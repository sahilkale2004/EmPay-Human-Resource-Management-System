...
router.get('/runs', authenticateToken, requireRole(['ADMIN', 'PAYROLL_OFFICER']), async (req, res) => {
  try {
...
router.post('/runs', authenticateToken, requireRole(['ADMIN', 'PAYROLL_OFFICER']), async (req, res) => {
  try {
...
router.post('/runs/:id/generate', authenticateToken, requireRole(['ADMIN', 'PAYROLL_OFFICER']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.put('/runs/:id/validate', authenticateToken, requireRole(['ADMIN', 'PAYROLL_OFFICER']), async (req, res) => {
...
router.get('/slips', authenticateToken, async (req, res) => {
  try {
    let query = `
...
router.get('/slips/:id', authenticateToken, async (req, res) => {
  try {
    const { id } = req.params;
