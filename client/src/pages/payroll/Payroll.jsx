      ...
      {activeTab === 'dashboard' ? (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <SummaryBox title="Total Payroll Cost" value={`₹${parseFloat(stats.totalCost).toLocaleString('en-IN')}`} link="Click for detail" />
            {canManage && (
              <div className="bg-[#FDFBF8] border border-[#DDD8CF] p-6 rounded-2xl shadow-sm flex flex-col items-center justify-center text-center relative overflow-hidden">
                ...
                <span className="text-3xl font-bold text-[#2A2520] mb-2">₹{parseFloat(fundBalance).toLocaleString('en-IN')}</span>
